...
app.post('/countries_insert', function (req, res) {
    ...
    dbconnection.query("INSERT INTO countries SET ?", data, function (error, results, fields) {
...
app.post('/happiness_insert', function (req, res) {
    ...
    dbconnection.query("INSERT INTO happiness_index_15 SET ?", data, function (error, results, fields) {
        if (error) throw error;
        return res.send({data: results});
    });
...
app.post('/suicide_insert', function (req, res) {
    ...
    dbconnection.query("INSERT INTO suicide_rates_15 SET ?", data, function (error, results, fields) {
        if (error) throw error;
        return res.send({data: results});
    });
